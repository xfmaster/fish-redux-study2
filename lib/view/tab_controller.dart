...
class MyTabController extends ChangeNotifier {
  ...
  MyTabController _copyWith({int index, int length, int previousIndex}) {
    return MyTabController._(
      index: index ?? _index,
...
class MyDefaultTabController extends StatefulWidget {
  ...
  /// ```
  static MyTabController of(BuildContext context) {
...
class _DefaultTabControllerState extends State<MyDefaultTabController>
  ...
  @override
  void didUpdateWidget(MyDefaultTabController oldWidget) {
