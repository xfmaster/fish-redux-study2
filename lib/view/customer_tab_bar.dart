...
double _indexChangeProgress(MyTabController controller) {
...
class _TabBarState extends State<CustomTabBar> {
  ...
  void _updateTabController() {
    final MyTabController newController =
        widget.controller ?? MyDefaultTabController.of(context);
    assert(() {
...
class TabPageSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final MyTabController tabController =
        controller ?? MyDefaultTabController.of(context);
    assert(() {
